	...
	return (
		<section ref={sectionRef} className="py-16 px-4 lg:px-8  bg-background">
			<div className="max-w-7xl mx-auto">
				...
				<div className="block lg:hidden mb-16">
					<div className="flex flex-col items-center relative z-10">
						<h2
							className={`${
								kanopiBrazil.className
							} text-[#FF314A] text-[120px] font-black leading-tight text-center tracking-tight transition-all duration-1000 delay-200 ${
								isVisible
						...
						<div className="mt-10 hidden md:block">
							<h1
								className={`${
									kanopiBrazil.className
								} text-foreground/8 pointer-events-none text-[100px] sm:text-[130px] w-full flex justify-center text-center absolute -top-22 z-5 left-1/2 -translate-x-1/2 font-black leading-tight tracking-tight transition-all duration-1000 ${
									isVisible
										? "opacity-100 translate-y-0"
										: "opacity-0 translate-y-8"
								}`}
				...
				<div
					className={`hidden lg:grid ${gridConfig.desktop} gap-8 lg:gap-12 items-center justify-items-center`}
				>
						...
						return (
							...
							>
								<Image
									...
									width={size.width}
									height={size.height}
									className="object-contain w-auto h-auto filter grayscale hover:grayscale-0 transition-all duration-300 group-hover:brightness-110 dark:invert dark:hover:invert-0 hover:scale-110"
				...
				<div
					className={`hidden md:grid ${gridConfig.tablet} lg:hidden gap-6 items-center justify-items-center z-10`}
				>
					{partners.map((partner, index) => {
				...
				<div
					className={`grid ${gridConfig.mobile} md:hidden gap-4 items-center justify-items-center z-10`}
				>
					{partners.map((partner, index) => {
